...
import MenuBarView from '../../../../views/apps/communicator/header-bar/menu-bar/menu-bar-view.js';
import SearchBarView from '../../../../views/apps/communicator/header-bar/search-bar/search-bar-view.js';
