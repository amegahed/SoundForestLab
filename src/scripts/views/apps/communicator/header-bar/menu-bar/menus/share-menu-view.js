...
export default MenuView.extend({
	...
	template: template(`
		...
		<li role="presentation" class="chat-option" style="display:none">
		...
		<li role="separator" class="divider chat-option post-option"></li>
		...
		<li role="presentation" class="topic-option chat-option">
		...
		<li role="separator" class="divider topic-option chat-option"></li>
	...
	templateContext: function() {
		return {
			features: config.apps.communicator.features
		}
	},
