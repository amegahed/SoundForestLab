...
import FirstButtonView from '../../../../../views/apps/help-viewer/footer-bar/page-bar/buttons/first-button-view.js';
import PrevButtonView from '../../../../../views/apps/help-viewer/footer-bar/page-bar/buttons/prev-button-view.js';
import NextButtonView from '../../../../../views/apps/help-viewer/footer-bar/page-bar/buttons/next-button-view.js';
import LastButtonView from '../../../../../views/apps/help-viewer/footer-bar/page-bar/buttons/last-button-view.js';
...
export default ToolbarView.extend({
	...
	update: function() {
		...
		//
		if (!this.pageNumber || !this.numPages || this.numPages <= 1) {
			this.$el.hide();
		} else {
			this.$el.show();
		}
	...
	onLoad: function() {
		let numPages = this.parent.app.numPages();
