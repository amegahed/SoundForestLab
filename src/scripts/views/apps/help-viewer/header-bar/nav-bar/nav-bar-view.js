...
import BackButtonView from '../../../../../views/apps/help-viewer/header-bar/nav-bar/buttons/back-button-view.js';
import ForwardButtonView from '../../../../../views/apps/help-viewer/header-bar/nav-bar/buttons/forward-button-view.js';
...
export default ToolbarView.extend({
	...
	back: function() {
		if (this.history.current != undefined && 
			...
			this.parent.app.setAddress(this.history[this.history.current], {
				silent: true
			});
