...
import MenuBarView from '../../../../views/apps/chat-viewer/header-bar/menu-bar/menu-bar-view.js';
import SearchBarView from '../../../../views/apps/chat-viewer/header-bar/search-bar/search-bar-view.js';
