		...
		<div class="sidebar-panels form-group">
			...
			<div class="controls">
				...
				<div class="checkbox-inline">
					<label><input type="checkbox" value="topic_info"<% if (sidebar_panels.includes('topic_info')) { %> checked<% } %>>Topic Info</label>
				</div>
		
				<div class="checkbox-inline">
					<label><input type="checkbox" value="topics"<% if (sidebar_panels.includes('topics')) { %> checked<% } %>>Topics</label>
				</div>
