...
import BackButtonView from '../../../../../views/apps/topic-browser/header-bar/nav-bar/buttons/back-button-view.js';
import ForwardButtonView from '../../../../../views/apps/topic-browser/header-bar/nav-bar/buttons/forward-button-view.js';
import NewTopicButtonView from '../../../../../views/apps/topic-browser/header-bar/nav-bar/buttons/new-topic-button-view.js';
...
export default ToolbarView.extend({
	...
	onRender: function() {
		...
		this.showChildView('new', new NewTopicButtonView());
	},
