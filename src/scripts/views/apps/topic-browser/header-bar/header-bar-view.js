...
import NavBarView from '../../../../views/apps/topic-browser/header-bar/nav-bar/nav-bar-view.js';
import MenuBarView from '../../../../views/apps/topic-browser/header-bar/menu-bar/menu-bar-view.js';
import SearchBarView from '../../../../views/apps/topic-browser/header-bar/search-bar/search-bar-view.js';
