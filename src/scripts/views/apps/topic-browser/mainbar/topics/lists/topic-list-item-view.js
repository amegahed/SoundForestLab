/******************************************************************************\
|                                                                              |
|                            topic-list-item-view.js                           |
|                                                                              |
|******************************************************************************|
|                                                                              |
|        This defines a view of a single topic list item.                      |
|                                                                              |
		...
		<div class="info">
			...
			<div class="specifics">
				...
				<div class="badges">
					...
					<% if (public) { %>
					<div class="protection badge" data-toggle="tooltip" title="public" data-placement="left">
						<i class="fa fa-globe"></i>
					</div>
					<% } else if (private) { %>
					<div class="protection badge" data-toggle="tooltip" title="private" data-placement="left">
						<i class="fa fa-lock"></i>
					</div>
					<% } %>
					<% if (subscribed) { %>
					<div class="subscribed success badge" data-toggle="tooltip" title="subscribed" data-placement="left">
