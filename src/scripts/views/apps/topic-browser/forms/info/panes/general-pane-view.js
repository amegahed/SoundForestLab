...
|******************************************************************************|
|                                                                              |
|        This is a form for a post topic's general information.                |
|                                                                              |
...
export default FormView.extend({
	...
	template: template(`
		...
		<% if (typeof num_posts == 'number') { %>
		<div class="num_posts form-group">
			<label class="control-label"><i class="fa fa-newspaper"></i>Posts</label>
			<div class="controls">
				<p class="form-control-static"><%= num_posts %>
			</div>
		</div>
		<% } %>
	`)
