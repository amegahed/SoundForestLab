...
import BackButtonView from '../../../../../views/apps/theme-manager/header-bar/nav-bar/buttons/back-button-view.js';
import ForwardButtonView from '../../../../../views/apps/theme-manager/header-bar/nav-bar/buttons/forward-button-view.js';
import UpButtonView from '../../../../../views/apps/theme-manager/header-bar/nav-bar/buttons/up-button-view.js';
