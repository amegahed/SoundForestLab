...
export default ButtonView.extend({
	...
	onRender: function() {
		...
		// set initial state
		//
		this.setDisabled(!this.parent.pageNumber || this.parent.pageNumber == this.parent.numPages || 
	...
	onClick: function() {
		if (this.parent.pageNumber < this.parent.numPages) {
			...
			// wraparound
			//
			this.getParentView('app').setPageNumber(1);
		}
	}
});
