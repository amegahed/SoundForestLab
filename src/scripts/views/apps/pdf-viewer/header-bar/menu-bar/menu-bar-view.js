...
import FileMenuView from '../../../../../views/apps/pdf-viewer/header-bar/menu-bar/menus/file-menu-view.js';
import ViewMenuView from '../../../../../views/apps/pdf-viewer/header-bar/menu-bar/menus/view-menu-view.js';
import FindMenuView from '../../../../../views/apps/pdf-viewer/header-bar/menu-bar/menus/find-menu-view.js';
import ShareMenuView from '../../../../../views/apps/pdf-viewer/header-bar/menu-bar/menus/share-menu-view.js';
import HelpMenuView from '../../../../../views/apps/pdf-viewer/header-bar/menu-bar/menus/help-menu-view.js';
