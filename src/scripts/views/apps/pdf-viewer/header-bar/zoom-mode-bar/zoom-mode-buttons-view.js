...
import FitSizeButtonView from '../../../../../views/apps/image-viewer/header-bar/zoom-mode-bar/buttons/zoom-mode-buttons/fit-size-button-view.js';
import FitWidthButtonView from '../../../../../views/apps/image-viewer/header-bar/zoom-mode-bar/buttons/zoom-mode-buttons/fit-width-button-view.js';
import FitHeightButtonView from '../../../../../views/apps/image-viewer/header-bar/zoom-mode-bar/buttons/zoom-mode-buttons/fit-height-button-view.js';
import ActualSizeButtonView from '../../../../../views/apps/image-viewer/header-bar/zoom-mode-bar/buttons/zoom-mode-buttons/actual-size-button-view.js';
