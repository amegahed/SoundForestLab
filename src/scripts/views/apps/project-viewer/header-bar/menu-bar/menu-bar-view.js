...
import FileMenuView from '../../../../../views/apps/project-viewer/header-bar/menu-bar/menus/file-menu-view.js';
import EditMenuView from '../../../../../views/apps/project-viewer/header-bar/menu-bar/menus/edit-menu-view.js';
import SelectMenuView from '../../../../../views/apps/project-viewer/header-bar/menu-bar/menus/select-menu-view.js';
import ViewMenuView from '../../../../../views/apps/project-viewer/header-bar/menu-bar/menus/view-menu-view.js';
import SortMenuView from '../../../../../views/apps/project-viewer/header-bar/menu-bar/menus/sort-menu-view.js';
import SearchMenuView from '../../../../../views/apps/project-viewer/header-bar/menu-bar/menus/search-menu-view.js';
import HelpMenuView from '../../../../../views/apps/project-viewer/header-bar/menu-bar/menus/help-menu-view.js';
...
export default MenuBarView.extend({
	...
	template: template(`
		...
		<li class="share dropdown" style="display:none">
