/******************************************************************************\
|                                                                              |
|                          contact-email-addr-view.js                          |
|                                                                              |
|******************************************************************************|
|                                                                              |
|        This is a view for displaying a contact's email addr.                 |
|                                                                              |
...
export default CardView.extend(_.extend({}, Expandable, {
	...
	getDescription: function() {
		return this.model.get('email_addr') || "this email addr";
	},
	...
	edit: function() {
		import(
			'../../../../../../views/apps/contact-editor/dialogs/contacts/edit/contacts/edit-user-email-addr-dialog-view.js'
