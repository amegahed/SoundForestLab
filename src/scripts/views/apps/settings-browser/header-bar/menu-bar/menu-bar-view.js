...
import FileMenuView from '../../../../../views/apps/settings-browser/header-bar/menu-bar/menus/file-menu-view.js';
import SelectMenuView from '../../../../../views/apps/settings-browser/header-bar/menu-bar/menus/select-menu-view.js';
import ViewMenuView from '../../../../../views/apps/settings-browser/header-bar/menu-bar/menus/view-menu-view.js';
import HelpMenuView from '../../../../../views/apps/settings-browser/header-bar/menu-bar/menus/help-menu-view.js';
