...
import FileMenuView from '../../../../../views/apps/code-editor/header-bar/menu-bar/menus/file-menu-view.js';
import EditMenuView from '../../../../../views/apps/code-editor/header-bar/menu-bar/menus/edit-menu-view.js';
import SelectMenuView from '../../../../../views/apps/code-editor/header-bar/menu-bar/menus/select-menu-view.js';
import FindMenuView from '../../../../../views/apps/code-editor/header-bar/menu-bar/menus/find-menu-view.js';
import ViewMenuView from '../../../../../views/apps/code-editor/header-bar/menu-bar/menus/view-menu-view.js';
import ShareMenuView from '../../../../../views/apps/code-editor/header-bar/menu-bar/menus/share-menu-view.js';
import HelpMenuView from '../../../../../views/apps/code-editor/header-bar/menu-bar/menus/help-menu-view.js';
...
export default MenuBarView.extend({
	...
	template: template(`
		...
		<li class="find dropdown">
			<a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-search"></i><span class="dropdown-title">Find</span></a>
			<div class="dropdown-menu"></div>
		</li>
	...
	onRender: function() {
		...
		this.showChildView('find', new FindMenuView());
	...
	onFound: function() {
		this.getChildView('find').onFound();
	},

	onReplaced: function() {
		this.getChildView('edit').onChange();
		this.getChildView('find').onReplaced();
	}
});