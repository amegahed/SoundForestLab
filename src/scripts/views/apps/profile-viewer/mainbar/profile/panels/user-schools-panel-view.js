/******************************************************************************\
|                                                                              |
|                          user-schools-panel-view.js                          |
|                                                                              |
|******************************************************************************|
|                                                                              |
|        This defines a read-only view of the user's work information.         |
|                                                                              |
...
import UserSchoolsView from '../../../../../../views/apps/profile-viewer/mainbar/profile/items/schools/user-schools-view.js';
...
export default BaseView.extend(_.extend({}, Expandable, {
	...
	template: template(`
		<div class="header info">
			...
			<div class="top buttons">
				...
				<% if (editable) { %>
				<button type="button" class="add success btn btn-sm" data-toggle="tooltip" title="Add School">
	...
	addItem: function() {
		import(
			...
			// show add dialog
			//
			application.show(new AddUserSchoolDialogView.default({
	...
	onRender: function() {
		...
		// show child views
		//
		this.showUserSchools();
	},

	showUserSchools: function() {
		this.showChildView('items', new UserSchoolsView({
