...
import UserJobsView from '../../../../../../views/apps/profile-viewer/mainbar/profile/items/jobs/user-jobs-view.js';
...
export default BaseView.extend(_.extend({}, Expandable, {
	...
	template: template(`
		<div class="header info">
			...
			<div class="buttons">
				...
				<% if (editable) { %>
				<button type="button" class="add success btn btn-sm" data-toggle="tooltip" title="Add Job">
	...
	showUserJobs: function() {
		this.showChildView('items', new UserJobsView({
