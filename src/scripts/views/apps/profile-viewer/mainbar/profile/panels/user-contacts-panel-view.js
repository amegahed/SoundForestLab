...
import UserContactsView from '../../../../../../views/apps/profile-viewer/mainbar/profile/items/contacts/user-contacts-view.js';
...
export default BaseView.extend(_.extend({}, Expandable, {
	...
	template: template(`
		<div class="header info">
			...
			<div class="buttons">
				...
				<% if (editable) { %>
				<button type="button" class="add success btn btn-sm" data-toggle="tooltip" title="Add Contact">
	...
	addItem: function() {
		import(
			'../../../../../../views/apps/profile-viewer/mainbar/profile/dialogs/add/add-user-contact-dialog-view.js'
	...
	showUserContacts: function() {
		this.showChildView('items', new UserContactsView({
