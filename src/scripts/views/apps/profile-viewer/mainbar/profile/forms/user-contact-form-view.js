...
import UserAddressFormView from '../../../../../../views/apps/profile-viewer/mainbar/profile/forms/contacts/user-address-form-view.js';
import UserWebsiteFormView from '../../../../../../views/apps/profile-viewer/mainbar/profile/forms/contacts/user-website-form-view.js';
...
export default FormView.extend({
	...
	submit: function(options) {
		...
		switch (this.getKind()) {
			case 'phone':
				return this.getChildView('phone').submit(options);
			case 'email-addr':
				return this.getChildView('email').submit(options);
			case 'address':
				return this.getChildView('address').submit(options);
			case 'website':
				return this.getChildView('website').submit(options);
		}
	},
