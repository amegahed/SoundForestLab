/******************************************************************************\
|                                                                              |
|                        edit-user-address-dialog-view.js                      |
|                                                                              |
|******************************************************************************|
|                                                                              |
|        This is a view for editing an address of a user's profile.            |
|                                                                              |
...
export default FormModalView.extend({
	...
	form: function() {
		return new UserAddressFormView({
			model: this.model,
	...
	onClickSave: function() {
		...
		if (!this.getChildView('form').submit({
			...
			error: (model, response) => {
				...
				//
				application.error({
					message: "Could not save user's address.",
					response: response
				});
			}
		})) {
