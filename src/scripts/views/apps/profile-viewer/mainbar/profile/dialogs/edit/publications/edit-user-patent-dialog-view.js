/******************************************************************************\
|                                                                              |
|                         edit-user-patent-dialog-view.js                      |
|                                                                              |
|******************************************************************************|
|                                                                              |
|        This is a view for editing a user's patent from their profile.        |
|                                                                              |
	...
	onClickSave: function() {
		...
		if (!this.getChildView('form').submit({
			...
			error: (model, response) => {
				...
				//
				application.error({
					message: "Could not save user's patent.",
					response: response
				});
			}
		})) {
