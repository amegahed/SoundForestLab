/******************************************************************************\
|                                                                              |
|                        add-user-school-dialog-view.js                        |
|                                                                              |
|******************************************************************************|
|                                                                              |
|        This is a dialog for adding a school to a user's profile.             |
|                                                                              |
...
import UserSchoolFormView from '../../../../../../../views/apps/profile-viewer/mainbar/profile/forms/user-school-form-view.js';
	...
	onClickSave: function() {
		...
		if (!this.getChildView('form').submit({
			...
			error: (model, response) => {
				...
				//
				application.error({
					message: "Could not save user's school.",
					response: response
				});
			}
		})) {
