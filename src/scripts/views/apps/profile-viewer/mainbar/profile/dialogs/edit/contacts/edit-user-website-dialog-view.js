/******************************************************************************\
|                                                                              |
|                       edit-user-website-dialog-view.js                       |
|                                                                              |
|******************************************************************************|
|                                                                              |
|        This is a view for editing a website of a user's profile.             |
|                                                                              |
...
export default FormModalView.extend({
	...
	form: function() {
		return new UserWebsiteFormView({
			model: this.model,
	...
	onClickSave: function() {
		...
		if (!this.getChildView('form').submit({
			...
			error: (model, response) => {
				...
				//
				application.error({
					message: "Could not save user's website.",
					response: response
				});
			}
		})) {
