...
export default PreferencesFormView.extend({
	...
	template: template(`
		<div class="window-size form-group">
			<label class="control-label"><i class="fa fa-th"></i>Window Size</label>
			<div class="controls">
				<select>
		...
		<div class="window-panes form-group">
			<label class="control-label"><i class="fa fa-pause"></i>Window Panes</label>
			<div class="controls">
		...
		<div class="sidebar-panels form-group">
			...
			<div class="controls">
				...
				<div class="checkbox-inline">
					<label><input type="checkbox" value="activity"<% if (sidebar_panels.includes('activity')) { %> checked<% } %>>Activity</label>
				</div>
		
				<div class="checkbox-inline">
					<label><input type="checkbox" value="status"<% if (sidebar_panels.includes('status')) { %> checked<% } %>>Status</label>
				</div>
		
				<div class="checkbox-inline">
					<label><input type="checkbox" value="actions"<% if (sidebar_panels.includes('actions')) { %> checked<% } %>>Actions</label>
				</div>
				
				<div class="checkbox-inline">
					<label><input type="checkbox" value="mutual_connections"<% if (sidebar_panels.includes('mutual_connections')) { %> checked<% } %>>Mutual Connections</label>
				</div>
