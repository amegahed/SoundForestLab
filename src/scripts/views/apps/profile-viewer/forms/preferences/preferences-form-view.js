...
import GeneralPrefsFormView from '../../../../../views/apps/profile-viewer/forms/preferences/general-prefs-form-view.js';
import DisplayPrefsFormView from '../../../../../views/apps/profile-viewer/forms/preferences/display-prefs-form-view.js';
...
export default PreferencesGroupView.extend({
	...
	showRegion: function(name) {
		switch (name) {
			case 'item':
				this.showAppIcon('profile_viewer');
				break;
			case 'general':
