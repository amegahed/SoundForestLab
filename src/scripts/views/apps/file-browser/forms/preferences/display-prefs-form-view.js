...
export default PreferencesFormView.extend({
	...
	template: template(`
		...
		<div class="window-panes form-group">
			...
			<div class="controls">
				...
				<div class="show-desktop-sidebar checkbox-inline">
					<label><input type="checkbox"<% if (show_desktop_sidebar) { %> checked<% } %>>Desktop Sidebar</label>
				</div>
		...
		<div class="sidebar-panels form-group">
			...
			<div class="controls">
				...
				<div class="checkbox-inline">
					<label><input type="checkbox" value="clipboard"<% if (sidebar_panels.includes('clipboard')) { %> checked<% } %>>Clipboard</label>
				</div>
				...
				<div class="checkbox-inline">
					<label><input type="checkbox" value="location"<% if (sidebar_panels.includes('location')) { %> checked<% } %>>Location</label>
				</div>
	...
	events: {
		...
		'change .show-desktop-sidebar input': 'onChangeShowDesktopSideBar',
	...
	getValue: function(key) {
		switch (key) {
			...
			case 'show_desktop_sidebar':
				return this.$el.find('.show-desktop-sidebar input').is(':checked');
			case 'sidebar_size':
	...
	getValues: function() {
		return {
			...
			show_desktop_sidebar: this.getValue('show_desktop_sidebar'),
	...
	setValue: function(key, value) {
		switch (key) {
			...
			case 'show_sidebar':
				...
				break;
			case 'show_desktop_sidebar':
				this.$el.find('.show-desktop-sidebar input[type="checkbox"]').prop('checked', value);
				break;
			case 'sidebar_size':
	...
	onChangeShowDesktopSideBar: function() {
		this.onChangeValue('show_desktop_sidebar', this.getValue('show_desktop_sidebar'));
	},
