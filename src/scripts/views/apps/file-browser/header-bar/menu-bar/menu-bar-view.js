...
import FileMenuView from '../../../../../views/apps/file-browser/header-bar/menu-bar/menus/file-menu-view.js';
import EditMenuView from '../../../../../views/apps/file-browser/header-bar/menu-bar/menus/edit-menu-view.js';
import SelectMenuView from '../../../../../views/apps/file-browser/header-bar/menu-bar/menus/select-menu-view.js';
import ViewMenuView from '../../../../../views/apps/file-browser/header-bar/menu-bar/menus/view-menu-view.js';
import SortMenuView from '../../../../../views/apps/file-browser/header-bar/menu-bar/menus/sort-menu-view.js';
import SearchMenuView from '../../../../../views/apps/file-browser/header-bar/menu-bar/menus/search-menu-view.js';
import ShareMenuView from '../../../../../views/apps/file-browser/header-bar/menu-bar/menus/share-menu-view.js';
import HelpMenuView from '../../../../../views/apps/file-browser/header-bar/menu-bar/menus/help-menu-view.js';
...
export default MenuBarView.extend({
	...
	onLoad: function() {
		let isWritable = this.app.model.isWritableBy(application.session.user);

		// call superclass method
		//
		MenuBarView.prototype.onLoad.call(this);

		// hide edit menu
		//
		if (!isWritable) {
			this.$el.find('.edit.dropdown').hide();
		}
	}
});