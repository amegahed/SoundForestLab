/******************************************************************************\
|                                                                              |
|                         open-text-file-dialog-view.js                        |
|                                                                              |
|******************************************************************************|
|                                                                              |
|        This defines a dialog for opening text files.                         |
|                                                                              |
...
export default OpenItemsDialogView.extend({
	...
	filter: function (child) {
		...
		//
		let extensions = application.settings.associations.getFileExtensions('text_editor');
