...
import GeneralPrefsFormView from '../../../../../views/apps/connection-manager/forms/preferences/general-prefs-form-view.js';
import DisplayPrefsFormView from '../../../../../views/apps/connection-manager/forms/preferences/display-prefs-form-view.js';
...
export default PreferencesGroupView.extend({
	...
	showRegion: function(name) {
		switch (name) {
			case 'item':
				this.showAppIcon('connection_manager');
				break;
			case 'general':
