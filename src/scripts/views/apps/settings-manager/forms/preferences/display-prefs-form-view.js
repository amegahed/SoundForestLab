		...
		<div class="sidebar-panels form-group">
			...
			<div class="controls">
				...
				<div class="checkbox-inline">
					<label><input type="checkbox" value="settings"<% if (sidebar_panels.includes('settings')) { %> checked<% } %>>Settings</label>
				</div>
		
				<div class="checkbox-inline">
					<label><input type="checkbox" value="preferences"<% if (sidebar_panels.includes('preferences')) { %> checked<% } %>>Preferences</label>
				</div>
