...
import TabsView from '../../../../../views/apps/tune-editor/mainbar/tabbed-content/tabs/tabs-view.js';
import TabPanesView from '../../../../../views/apps/tune-editor/mainbar/tabbed-content/tab-panes/tab-panes-view.js';
...
export default TabbedContentView.extend({
	...
	setSideBarSize: function(value) {

		// apply to children
		//
		for (let i = 0; i < this.getChildView('panes').children.length; i++) {
			this.getChildView('panes').getChildViewAt(i).getChildView('content').setSideBarSize(value);
		}		
	}
});