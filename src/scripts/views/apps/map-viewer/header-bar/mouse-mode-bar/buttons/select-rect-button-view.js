...
import MouseDragRectSelectBehavior from '../../../../../../views/apps/map-viewer/mainbar/behaviors/selecting/mouse-drag-rect-select-behavior.js';
...
export default MouseModeButtonView.extend({
	...
	activate: function() {
		...
		if (viewport) {
			this.behaviors = [
				new MouseDragRectSelectBehavior(viewport, {
					itemsView: itemsView,
					button: 1,
					on: false
				}),
