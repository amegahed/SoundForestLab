/******************************************************************************\
|                                                                              |
|                         select-project-form-view.js                          |
|                                                                              |
|******************************************************************************|
|                                                                              |
|        This defines a form for selecting task projects.                      |
|                                                                              |
|******************************************************************************|
...
export default FormView.extend({
	...
	hasSelected: function() {
		if (this.hasChildView('projects')) {
			return this.getChildView('projects').hasSelected();
		}
	},
	...
	getValue: function(key) {
		switch (key) {
			...
			case 'project':
				return this.$el.find('.project-name select').val();
		}
	},
	
	getValues: function() {
		return {
			name: this.getValue('project')
		};
	},

	getSelected: function() {
		return this.getChildView('projects').getSelected();
	},
	...
	showTopicSelector: function() {
		...
		this.showChildView('projects', new ModelSelectorView({
	...
	onChangeTopic: function() {
		let index = this.getChildView('projects').getSelectedIndex();
