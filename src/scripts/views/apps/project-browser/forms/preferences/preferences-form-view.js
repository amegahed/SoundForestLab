...
import GeneralPrefsFormView from '../../../../../views/apps/project-browser/forms/preferences/general-prefs-form-view.js';
import DisplayPrefsFormView from '../../../../../views/apps/project-browser/forms/preferences/display-prefs-form-view.js';
...
export default PreferencesGroupView.extend({
	...
	showRegion: function(name) {
		switch (name) {
			case 'item':
				this.showAppIcon('project_browser');
				break;
			case 'general':
