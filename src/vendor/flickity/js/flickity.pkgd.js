...
proto.setTranslateX = function(x) {
	...
	if (!this.isAnimating) {
		...
		// set margin
		//
		this.slider.style.marginLeft = translateX;
		this.usingMargin = true;

		// clear transform
		//
		if (this.usingTransform) {
			this.slider.style.transform = '';
			this.usingTransform = false;
		}

		// undo optimization
		//
		this.slider.style.webkitBackfaceVisibility = '';
		this.slider.style.webkitPerspective = '';
	} else {
...
Flickity.defaults = {
	...
	// contain: false,
	freeScrollFriction: 0.5, 	// friction when free-scrolling
	friction: 0.2, 				// friction when selecting
